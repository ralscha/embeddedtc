...
/**
 * Convenient JUnit test class that starts a Tomcat on port 9998 before the test and stops it afterwards. Extend your
 * JUnit test class with this class.
 * 
 * @author Ralph Schaer
 */
public class TomcatTest {
	...
	/**
	 * Starts an embedded tomcat on port 9998. Does not print any log messages and does not add a shutdown hook
	 */
	@BeforeClass
